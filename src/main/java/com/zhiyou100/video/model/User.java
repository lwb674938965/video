...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", nickName=" + nickName + ", sex=" + sex + ", birthday=" + birthday
				+ ", birthdayStr=" + birthdayStr + ", email=" + email + ", province=" + province + ", city=" + city
				+ ", headUrl=" + headUrl + ", password=" + password + ", newPassword=" + newPassword + ", oldPassword="
				+ oldPassword + ", insertTime=" + insertTime + ", updateTime=" + updateTime + ", captcha=" + captcha
				+ "]";
	}
