...
<head>
    ...
    <%@include file="/WEB-INF/view/front/include/style.html"%>
...
<div>
    ...
    <%@include file="/WEB-INF/view/front/include/footer.jsp"%>
    ...
    <script>
        $(function () {
        	var id = $('#videoId').val();
           $('#content').load('${pageContext.request.contextPath }/front/video/videoData.do?videoId='+id);
           
           //播放量统计,不需要返回结果处理
           //$.get('${pageContext.request.contextPath }/front/video/state.do?videoId='+id);
           $.get('${pageContext.request.contextPath }/front/video/state.do',{"videoId":id});
		});
    </script>
</body>
