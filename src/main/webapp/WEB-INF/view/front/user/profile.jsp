                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form action="${pageContext.request.contextPath }/front/user/profile.do" method="post">
                                ...
                                <div class="form_group">
                                    <span class="dd">生&#x3000;日：</span><%-- value='<fmt:formatDate value="${user.birthdayStr}" type="both" pattern="yyyy-MM-dd"/>' --%>
