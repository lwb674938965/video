...
<div class="mask hidden" id="loginDiv">
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="loginForm"  method="post"><!-- action="/front/user/login.action" -->
				<h3>快速登录</h3>
				...
				<input type="submit" value="登&#x3000;录" id="submitId">
			</form>
		</div>
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="regForm" action="${pageContext.request.contextPath }/front/user/regist.do" method="post">
				<h3>新用户注册</h3>
				<input type="email" id="regEmail" placeholder="请输入邮箱" name="email" onblur="checkEmail(this)">
				...
				<input type="submit" value="注&#x3000;册" id="registId">
			</form>
		</div>
		<div class="mask_content_footer">
...
<script type="text/javascript">
	...
	function checkEmail(the){
		$.ajax({
            url:"${pageContext.request.contextPath }/front/user/checkEmail.do",
            dataType:"text",
            type:"get",
			data:{"email":the.value},
