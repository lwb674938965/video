	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				...
				<a href="${pageContext.request.contextPath }/front/user/index.do?id=${sessionScope._front_user.id}" id="account">${sessionScope._front_user.email }</a>
			</div>
		</c:if>
		...
		<a target="_blank" href="${pageContext.request.contextPath }/admin/video/login.action"><img src="${pageContext.request.contextPath }/img/we.png" draggable="false">后台管理</a>
