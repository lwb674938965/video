	    ...
	    <div class="container">
			...
			<div>
				<div class="navbar-form navbar-left">
					<a href="${pageContext.request.contextPath }/admin/course/addCourse.action" class="btn btn-primary">添加课程</a>
				</div>
				<div style="margin-top: 10px;">
					<table class="table table-hover">
						...
						<tr>
							...
							<td>
								<a class="glyphicon glyphicon-edit" role="button" href="${pageContext.request.contextPath }/admin/course/editCourse.action?id=${course.id}&page=${page.page}"></a>
							</td>
							<td>
             ...
             <div>
			   <div style="float:right;margin-right: 50px;margin-top: -10px; ">  
                ...
                <bobo:page url="${pageContext.request.contextPath }/admin/course/courseList.action"></bobo:page>
                </div>
