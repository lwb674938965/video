...
<html>
	...
	<jsp:include page="/WEB-INF/view/admin/admin.jsp">
		...
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath }/admin/video/editVideo.action" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="inputPassword3" name="speakerId" >
							...
							<option value="${sl.id }" ${video.speakerId == sl.id ? "selected":"" }>${sl.speakerName }</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="inputPassword3" name="courseId">
							...
							<option value="${cl.id }" ${video.courseId == cl.id ? "selected":"" }>${cl.courseName }</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3" placeholder="视频时长(秒)" name="videoLength" value="${video.videoLength }">
					</div>
				</div>
				<div class="form-group">
