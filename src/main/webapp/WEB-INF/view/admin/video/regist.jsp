...
<html>
	...
	<head>
		...
		function orExist(the){
			$.ajax({
			    ...
			    url:"${pageContext.request.contextPath }/admin/video/regist.action",
	...
	<body>
		...
		<div style="margin:20% 40%;">
			...
			<form action="${pageContext.request.contextPath }/admin/video/addAdmin.action" method="post" id="formId"> 
