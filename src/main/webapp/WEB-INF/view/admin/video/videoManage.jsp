		...
		<div class="container theme-showcase">
			...
			<div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<form class="navbar-form navbar-right" action="${pageContext.request.contextPath }/admin/video/videoManage.action" method="post">
            ...
            <form action="${pageContext.request.contextPath }/admin/video/deleteAll.action">
			<table class="table table-hover">
			 <thead>
			     ...
			     <tr>
			     	...
			     	<td><a class="glyphicon glyphicon-edit" role="button" href="${pageContext.request.contextPath }/admin/video/editVideo.action?id=${video.id}&page=${page.page}"></a></td>
			...
			<div>
			   <div style="float:right;margin-right: 50px;margin-top: -10px; ">  
                ...
                <bobo:page url="${pageContext.request.contextPath }/admin/video/videoManage.action"></bobo:page>
                </div>
