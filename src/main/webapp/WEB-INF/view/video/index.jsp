...
<html>
	...
	<body>
		...
		<div style="margin:20% 40%;">
			...
			<form action="${pageContext.request.contextPath }/video/login.action" method="post" id="formId"> 
				...
				<input type="password" class="form-control" id="exampleInputPassword1"  name="prepassword" placeholder="确认密码" value=""><br/>
